      ...
      <CardContent className="space-y-2 pt-0">
        {currentSchedule.map((task) => {
          ...
          return (
            <div
              key={task.id}
              className={`rounded p-2 ${colorConfig?.bg} flex items-center justify-between transition-all duration-200 hover:shadow-sm`}
            >
        ...
        {currentSchedule.length > 0 && (
          <div className="space-y-2 pt-2">
            <Button
              ...
              variant="outline"
              size="sm"
              className="w-full transition-colors hover:bg-cyan-50"
            >
              Fill Breaks
            </Button>
            <Button onClick={handleShareCurrentDay} size="sm" className="w-full">
              Share This Day
            </Button>
            <Button
              ...
              variant="outline"
              size="sm"
              className="text-destructive border-destructive hover:bg-destructive hover:text-destructive-foreground w-full transition-colors"
            >
              Clear All
            </Button>
          </div>
